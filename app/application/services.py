...
class LocalModelService:
    ...
    def config(self) -> dict[str, Any]:
        return {
            ...
            "auto_unload": bool(self.settings.get("lmstudio_auto_unload", False)),
        }
    ...
    def save_config(
        ...
        *,
        ...
        self.settings.set("lmstudio_auto_unload", bool(auto_unload))
    ...
    def end_queue_model_session(self, session: dict[str, Any] | None) -> ServiceResult:
        if not self.config().get("auto_unload", False):
            return ServiceResult(True, "Auto-unload is disabled.")
...
# ---------------------------------------------------------------------------
#  Dialogue Attribution Mode (DAM) — Tinted Dialogue
# ---------------------------------------------------------------------------

from app.application.dam_service import DamService
